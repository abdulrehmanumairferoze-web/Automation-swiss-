    ...
    return (
        <div className="py-16 text-center px-6 md:px-10 flex flex-col items-center">
            ...
            {report && (
                <div
                    ref={reportRef}
                    className="mt-12 text-left max-w-5xl w-full mx-auto p-10 md:p-14 bg-[#0b1120] rounded-[3rem] text-white shadow-3xl border border-white/5 animate-in slide-in-from-bottom-5 overflow-auto"
                >
                    <div className="flex justify-between items-start mb-10 border-b border-white/10 pb-8 relative">
                        <div>
                        ...
                        <div className="flex items-center gap-4">
                            <button
                                ...
                                className="bg-white/5 hover:bg-white/10 text-white p-3 rounded-2xl border border-white/10 transition-all group flex items-center gap-2"
                            ...
                            <div className="bg-white/5 px-6 py-4 rounded-2xl border border-white/10 hidden lg:block">
